...
function prodListAddToCart() {
    let atcB = Array.from(document.querySelectorAll(thumbnailAddToCartButtons));
    atcB.forEach(button => {
        button.addEventListener('click', function () {
            let prodId = button.getAttribute(thumbnailAddToCartProductId);
            let container = getParentBySelector(button, thumbnailAddToCartDetailsParent);
            let name = container.querySelector(thumbnailProductName).innerText;
            let price = parseFloat(container.querySelector(thumbnailProductPrice).innerText);
...
function trackProductViewAndProductCart() {
    ...
    let price = parseInt(document.querySelector(productPagePrice).content);
    ...
    let addToCartButtons = Array.from(document.querySelectorAll(productPageAddToCartButtons));
    addToCartButtons.forEach(button => {
        button.addEventListener('click', function () {
            let quantity = parseInt(document.querySelector(productPageQantity).value);
            let params = {
